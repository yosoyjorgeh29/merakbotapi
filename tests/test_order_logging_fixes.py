...
async def test_fixes():
    ...
    try:
        ...
        immediate_result = await client_with_logs.check_order_result(order_result.order_id)
        if immediate_result:
    ...
    try:
        ...
        # Check if order is properly tracked
        immediate_result = await client_no_logs.check_order_result(order_result.order_id)
        if immediate_result:
