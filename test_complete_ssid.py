...
async def test_complete_ssid_format():
    ...
    print(f"📝 Testing with complete SSID format:")
    ...
    print(f"📝 Testing with raw session ID:")
...
async def main():
    ...
    print('   client = AsyncPocketOptionClient(ssid="your_session", uid=your_uid, is_demo=True)')
