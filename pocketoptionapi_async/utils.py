...
def calculate_payout_percentage(entry_price: float, exit_price: float, 
                              direction: str, payout_rate: float = 0.8) -> float:
    """
...
def calculate_order_expiration(duration_seconds: int, 
